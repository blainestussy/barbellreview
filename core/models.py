...
class Location(models.Model):
    ...
    gymtype = models.IntegerField(choices=GYM_CHOICES, null=True, blank=True)
    proshop = models.IntegerField(choices=YESNO_CHOICES, null=True, blank=True)
